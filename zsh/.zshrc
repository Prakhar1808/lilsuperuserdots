...
plugins=(git archlinux zsh-syntax-highlighting zsh-autosuggestions history-substring-search)
...
# for ctrl + backspace to del a word
...
ZSH_HIGHLIGHT_STYLES[comment]='fg=#ffcfc4,italic'  # Use any hex code you like

pokemon-colorscripts() {
    if [[ "$*" == "-n nitya" ]]; then
        command pokemon-colorscripts -s -n jigglypuff
    else
